    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item"><a class="nav-link" href="update.phpl">Update</a></li>
            ...
            <div class="text-center my-5">
                ...
                <form class="row g-3" method="POST" action="#">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="int" class="form-control" id="validationDefault02" name="contact" value="" required>
                    </div>
                    <div class="col-md-4">
                        <label for="validationDefault02" class="form-label">Salary</label>
                        <input type="integer" class="form-control" id="validationDefault02" name="salary" value="" required>
                    </div>
                    <div class="col-md-8">
                    ...
                    <div class="col-md-1">
                        ...
                        <input type="text" name="age" class="form-control" id="validationDefault05" required>
                    </div>
                    <div class="col-md-3">
